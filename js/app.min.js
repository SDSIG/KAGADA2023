! function (n, t, e) {
    var o = {
        ...
        navbarChange: function () {
            n(t).scroll(function () {
                var e = n(t).scrollTop();
                return 0 <= e ? (n("#header-navbar").removeClass("navbar-transparent"), n("body").addClass("not-on-top")) : (n("body").removeClass("not-on-top"), n("#header-navbar").addClass("navbar-transparent")), !1
            })
        }
    };
    n(e).ready(function () {
